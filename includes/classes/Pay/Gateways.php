...
class Pay_Gateways {
    ...
    public static function _getGateways($arrDefault) {
        ...
        $paymentOptions = array(
            ...
            //'Pay_Gateway_Cashticket',
//            'Pay_Gateway_Clickandbuy',
//            'Pay_Gateway_Directebankingat',
//            'Pay_Gateway_Directebankingbe',
//            'Pay_Gateway_Directebankingch',
            'Pay_Gateway_Sofortbanking',
//            'Pay_Gateway_Directebankinggb',
//            'Pay_Gateway_Directebankingnl',
            //'Pay_Gateway_Fasterpay',
            'Pay_Gateway_Giropay',
            'Pay_Gateway_Ideal',
            'Pay_Gateway_Incasso',
            'Pay_Gateway_Maestro',
